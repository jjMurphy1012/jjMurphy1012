...
Tech: LangGraph, Spring Boot 3, FastAPI, React 18, pgvector, Redis Streams, Docker Compose  
Repo: [RunbookAgent](https://github.com/jjMurphy1012/Runbook_agent)

### Online Order

A full-stack food ordering application with Spring Boot APIs, React frontend, PostgreSQL persistence, Spring Security authentication, and AWS deployment.

Tech: Spring Boot, React, PostgreSQL, Spring Security, AWS RDS, AWS ECR, App Runner  
Repo: [Online Order](https://github.com/jjMurphy1012/OnlineOrder)
...
Tech: Kotlin, Jetpack Compose, Retrofit, OkHttp, Room, Hilt, Coil  
Repo: [miniSpotify](https://github.com/jjMurphy1012/miniSpotify)

## Tech Stack

Java, TypeScript, JavaScript, Go, SQL  
React, React Native, Expo, Spring Boot, Spring Security, NestJS, FastAPI, Node.js  
